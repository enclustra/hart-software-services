...
#ifdef CONFIG_UART_SELECT_MULTIPLEXER_PRESENT
#  define UART_SELECT_MULTIPLEXER_PRESENT true
#  define UART_SELECT_MULTIPLEXER_ADRESS CONFIG_UART_SELECT_MULTIPLEXER_ADRESS
#else
#  define UART_SELECT_MULTIPLEXER_PRESENT false
#  define UART_SELECT_MULTIPLEXER_ADRESS 0x40000000
#endif

/* Set Address of SD/eMMC multiplexer select */
#ifdef FABRIC_SD_EMMC_DEMUX_SELECT_ADDRESS
#   undef FABRIC_SD_EMMC_DEMUX_SELECT_ADDRESS
#endif
#define FABRIC_SD_EMMC_DEMUX_SELECT_ADDRESS CONFIG_SERVICE_MMC_FABRIC_SD_EMMC_DEMUX_SELECT_ADDRESS
